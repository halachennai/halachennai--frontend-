...
const Toc = () => {
  return (
    <div className="legal-terms">
      ...
      <p>
        We are Hala Chennai ('Company', 'we', 'us', or 'our'), a company
        registered in India at Azad nagar 1 street Aminjikari, Chennai, Tamil
        Nadu 600029.
      </p>
      <p>
        We operate the website{" "}
        <a href="https://halachennai-frontend-o6lj.vercel.app/">
      ...
      <p>
        ...
        <a href="mailto:halachennai@gmail.com">halachennai@gmail.com</a>, or by
        mail to Azad nagar 1 street Aminjikari, Chennai, Tamil Nadu 600029,
        India.
      </p>
      <p>
        These Legal Terms constitute a legally binding agreement made between
        you, whether personally or on behalf of an entity ('you'), and Hala
        Chennai, concerning your access to and use of the Services. You agree
      ...
      <p>
        ...
        <a href="mailto:halachennai@gmail.com">halachennai@gmail.com</a>, as
      ...
      <p>
        ...
        Express - Discover - PayPal You agree to provide current, complete, and
        ...
        shall be in Indian rupee. You agree to pay all charges at the prices
      ...
      <p>
        At Hala Chennai, we want you to be completely satisfied with your
        purchase. Please review our Return Policy posted on the Services prior
        to making any purchases. If you have purchased a customized shirt,
        please note that returns are not accepted for these items, as they are
        made specifically for you. However, for other products, you may return
        them within the stipulated time frame provided in our policy, given that
        they are unused, in original packaging, and in a resalable condition. We
        recommend contacting our customer service team if you have any questions
      ...
      <p>
        ...
        unauthorised framing of or linking to the Services. Upload or transmit
        ...
        use or launch any unauthorised script or other software. Use a buying
        ...
        to advertise or offer to sell goods and services.
      </p>
      ...
      <p>
        ...
        problems or need to perform maintenance related to the Services,
        resulting in interruptions, delays, or errors. We reserve the right to
        change, revise, update, suspend, discontinue, or otherwise modify the
      ...
      <p>
        ...
        India. Hala Chennai and yourself irrevocably consent that the courts of
      ...
      <p>
        ...
        provided below) informally for at least twenty one (21) days before
        ...
        be three (3). The seat, or legal place, or arbitration shall be Chennai
      ...
      <p>
        Opting Out If at any time you wish to stop receiving SMS messages from
        us, simply reply to the text with "STOP.” You may receive an SMS message
        confirming your opt out. Message and Data Rates Please be aware that
        message and data rates may apply to any SMS messages sent or received.
        The rates are determined by your carrier and the specifics of your
        mobile plan. Support If you have any questions or need assistance
        regarding our SMS communications, please email us at
        halachennai@gmail.com or call at 9445358569.
      </p>
      ...
      <p>
        ...
        Hala Chennai Azad nagar 1street Aminjikari Chennai , Tamilnadu 600029
        India Phone: 9445358569 halachennai@gmail.com
      </p>
    </div>
  );
};
